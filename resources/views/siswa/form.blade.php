...
@section('main-content')
    <div class="breadcrumb">
        <h1>Data Siswa</h1>
        <ul>
            <li><a href="{{route('siswa.home')}}">Siswa Management</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="needs-validation" action="{{route('siswa.store')}}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control @error('username') is-invalid @enderror" name="username"
                                       type="text" value="{{ old('username', $siswa->username ) }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat"
                                          ...
                                          required>{{$siswa->alamat != null ? $siswa->alamat : old('alamat')}}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <input class="form-control @error('nilai_rapot') is-invalid @enderror"
                                       ...
                                       value="{{old('nilai_rapot', $siswa->nilai_rapot)}}" step=".01" required>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <input type="file" name="foto_siswa"
                                       ...
                                       placeholder="foto_siswa" id="foto_siswa" onchange="previewFotoSiswa()">
                            ...
                            <div class="col-md-6">
                                ...
                                @endif
                                <input type="file" name="foto_rapot"
                                       class="form-control @error('foto_rapot') is-invalid @enderror"
                                       placeholder="foto_rapot" id="foto_rapot" onchange="previewFotoRapot()">
                        ...
                        <div class="mc-footer">
                            <div class="row text-right">
                                <div class="col-lg-12 text-right">
                                    <a href="{{route('siswa.home')}}" class="btn btn-outline-secondary m-1">Cancel</a>
