        ...
        <div class="dropdown">
            <div  class="user col align-self-end">
                @if(Auth::user()->foto_siswa != null)
                    <img src="{{asset('storage/'.Auth::user()->foto_siswa)}}" id="userDropdown" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                @else
...
<div class="modal fade" id="changePasswordModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{route('siswa.home.changePassword')}}" method="POST">
                {{ method_field('post') }}
                {{ csrf_field() }}
